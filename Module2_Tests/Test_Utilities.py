...
from pyspark.sql.types import StringType, StructType, DoubleType, IntegerType, LongType

u = Utility()
config = configparser.ConfigParser()
config.read(r'../Module2_Tests/Config_Files/test_utilities_config.ini')
...
class TestUtility(unittest.TestCase):
    ...
    def test_readFile(self):
        ...
        col_expected = ["REF_ID", "ORIG", "BENEF"]
    ...
    def test_readFileWithSchema(self):
        ...
        schema = StructType() \
            .add('REF_ID', LongType(), True) \
            .add('ORIG', StringType(), True) \
            .add('BENEF', StringType(), True)

        act_df = u.readFileWithSchema("csv", schema, sample_Data, ",")
        act_df = act_df.sort("REF_ID")

        exp_columns = ["REF_ID", "ORIG", "BENEF"]
        exp_data = [(1, "Jack", "Harry"), (2, "John", "Jack"),
                    (3, "Harry", "Tom"), (4, "Tom", "Jack"), (5, "Bruce", "Jackie")]
